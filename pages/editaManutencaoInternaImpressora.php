...
<title>Manutenção interna de impressora</title>
...
<?php 
$idManutencaoInterna = $_GET['idManutencaoInternaImpressora']; // Recebendo o valor vindo do link
...
?>
	...
	<form action = "../sql/edita_manutencaoInternaImpressora_sql.php" = method="post" id="mp">

		<fieldset>
		
		<legend>Edita manutenção interna de PC</legend>
		<input type="hidden" name="idManutencaoInternaImpressora" value="<?php echo $linha->idManutencaoInternaImpressora; ?>"/> 
			...
			<input type="button" value="Voltar" onclick="location.href= 'manutencaoInternaImpressora.php'">
