...
<fieldset id="pesquisa">
	...
	$sql = mysql_query
	("SELECT maquinaDesktop.idMaquinaDesktop, maquinaDesktop.bemPatrimonial, maquinaDesktop.empresaID, maquinaDesktop.notaFiscal, maquinaDesktop.valor, maquinaDesktop.dataAquisicao, maquinaDesktop.tempoGarantia, maquinaDesktop.departamentoID, maquinaDesktop.marcaID, maquinaDesktop.sistemaOperacional, maquinaDesktop.placaMae, maquinaDesktop.processador, maquinaDesktop.hd, maquinaDesktop.slot1, maquinaDesktop.slot2, maquinaDesktop.fonte, maquinaDesktop.descricao, departamento.idDepartamento, departamento.nome AS departamento, fornecedor.idFornecedor, fornecedor.fantasia AS empresa, montadora.idMontadora, montadora.nome AS marca
	FROM maquinaDesktop
	...
	<tr>
	<td><a href="manutencaoInternaPC.php?p=<?php echo $pc->bemPatrimonial;?>"><?php echo $pc->bemPatrimonial;?></a></td>
	...
	INNER JOIN fornecedor ON fornecedor.idFornecedor=maquinaDesktop.empresaID
	INNER JOIN montadora ON montadora.idMontadora=maquinaDesktop.marcaID
	WHERE maquinaDesktop.departamentoID LIKE '%".$conteudoBusca."%' 
	AND maquinaDesktop.status=1 ORDER BY maquinaDesktop.bemPatrimonial");  
	...
	<tr>
	<td><?php echo $pc->bemPatrimonial;?></a></td>
	<td><?php echo $pc->empresa;?></td>
	<td><?php echo $pc->notaFiscal;?></td>
	<td><?php echo $pc->valor;?></td>
	<td><?php echo date('d/m/Y',strtotime($pc->dataAquisicao));?></td>
	...
	echo "<fieldset><p id = 'textoPequeno'>Nenhuma máquina foi encontrada com esta especificação.</p><br><br><br></fieldset>"; } 
	} // fim do if
	...
	INNER JOIN fornecedor ON fornecedor.idFornecedor=maquinaDesktop.empresaID
	INNER JOIN montadora ON montadora.idMontadora=maquinaDesktop.marcaID
	WHERE maquinaDesktop.processador LIKE '%".$conteudoBusca."%' 
	AND maquinaDesktop.status=1 ORDER BY maquinaDesktop.bemPatrimonial");   
	...
	<td><?php echo $pc->fonte;?></td>	
	<td><?php echo $pc->descricao;?></td>	
	<td><a href="manutencaoInternaPC.php?conteudoBusca=<?php echo $pc->bemPatrimonial; ?>">+histórico</a></td>
	<td><a href="editaMaquinaDesktop.php?idMaquinaDesktop=<?php echo $pc->idMaquinaDesktop; ?>">Editar</a></td> 
	<td><a href="../sql/deletaMaquinaDesktop_sql.php?idMaquinaDesktop=<?php echo $pc->idMaquinaDesktop; ?>" onclick="return confirm('Confirma exclusão do registro?')">Excluir</a></td>
	</tr>	
	...
	echo "<fieldset><p id = 'textoPequeno'>Nenhuma máquina foi encontrado com esta especificação.</p><br><br><br></fieldset>"; } 
	} // fim do if
	...
	INNER JOIN fornecedor ON fornecedor.idFornecedor=maquinaDesktop.empresaID
	INNER JOIN montadora ON montadora.idMontadora=maquinaDesktop.marcaID
	WHERE maquinaDesktop.marcaID LIKE '%".$conteudoBusca."%' 
	AND maquinaDesktop.status=1 ORDER BY maquinaDesktop.bemPatrimonial");   
