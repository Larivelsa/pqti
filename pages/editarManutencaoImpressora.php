...
$sql = mysql_query("SELECT * FROM manutencaoImpressora WHERE idManutencaoImpressora = '".$idManutencaoImpressora."'"); 
...
<form action = "../sql/edita_manutencaoImpressora_sql.php" = method="post" id="mi">
	...
	<textarea name="descricao" form="mi" text="<?php echo $linha->descricao;?>"></textarea><br><br>
