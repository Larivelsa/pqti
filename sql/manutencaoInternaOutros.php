...
<section id="conteudo">
	...
	<a href="">Registrar manutenção interna em geral</a>
	...
	<label>Se a manutenção não estiver no sistema, <a href="cadastra_manutencaoInternaOutros.php">registre a manutenção.</a></label><br><br><br>
	...
	$sql = mysql_query("SELECT * FROM manutencaoInternaOutros WHERE descricao LIKE '%".$conteudoBusca."%' AND status = '1' ORDER BY departamento");   
	...
	<td><a href="editaManutencaoOutros.php?idManutencaoInternaOutros=<?php echo $manutencaoInternaOutros->idManutencaoInternaOutros; ?>">Editar</a></td> 
	...
	echo "Nenhuma manutenção foi encontrada com o nome ".$conteudoBusca.""; } 
	} // fim do if
